...
open class DiscoverTVMDB: DiscoverMDB {
  ...
  open class func discoverTV(_ api_key: String, language: String?, sort_by: String? = nil, page: Int?, completionHandler: @escaping (_ clientReturn: ClientReturn, _ data: [TVMDB]?) -> ()) -> (){
  ...
  open class func discoverTV(_ api_key: String, first_air_date_year: String? = nil, first_air_date_gte: String? = nil, first_air_date_lte: String? = nil, air_date_gte: String? = nil, air_date_lte: String? = nil, language: String?, sort_by: String? = nil, page: Int?, timezone: String? = nil, completionHandler: @escaping (_ clientReturn: ClientReturn, _ data: [TVMDB]?) -> ()) -> (){
  ...
  open class func discoverTV(_ api_key: String, language: String?, sort_by: String? = nil, page: Int?, first_air_date_year: String? = nil, first_air_date_gte: String? = nil, first_air_date_lte: String? = nil, air_date_gte: String? = nil, air_date_lte: String? = nil, timezone: String? = nil, vote_average_gte: Double?, vote_count_gte: Double?, with_genres: String? = nil, with_networks: String? = nil, completionHandler: @escaping (_ clientReturn: ClientReturn, _ data: [TVMDB]?) -> ()) -> (){
